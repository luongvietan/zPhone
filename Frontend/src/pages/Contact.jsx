      ...
      <section className="relative z-10 overflow-hidden bg-white py-16 dark:bg-dark lg:py-[90px]">
        <div className="container mx-auto max-w-[80%]">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      Phuoc Kien, Nha Be, Ho Chi Minh City, Viet Nam
                    </p>
                  </div>
                </div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-white p-6 shadow-lg dark:bg-dark-2 sm:p-10">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-black w-full rounded border border-primary bg-primary p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
